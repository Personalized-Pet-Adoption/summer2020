# Generated by Django 3.0.3 on 2020-07-21 00:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_auto_20200721_0002'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_adopters', models.ManyToManyField(blank=True, related_name='favorites', to='accounts.Adopter')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pets', to='accounts.Seller')),
            ],
        ),
        migrations.CreateModel(
            name='Immune',
